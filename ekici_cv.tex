...
\begin{tabular}{ll}	
2026 & {\href{https://dl.acm.org/doi/10.1145/3815176}{Formalising Asynchronous Session Subtyping}}\\
& ACM Transactions on Computational Logic\\
&  \emph{Burak Ekici} and Nobuko Yoshida.
 \\[0.20cm]
...
% \\[0.40cm]
%Preprint & 
%\href{}{Formalising Asynchronous Session Subtyping}\\
%& ACM Transactions on Computational Logic (Under Review)\\
%& \emph{Burak Ekici}, and Nobuko Yoshida.
\end{tabular}
...
\begin{longtable}{ll}	
2025 & 
{\href{}{Formalising Subject Reduction and Progress for Multiparty Session Processes}} \\
& Sixteenth Conference on Interactive Theorem Proving (ITP -- to appear) \\
& \emph{Burak Ekici}, Tadayoshi Kamegai, and Nobuko Yoshida.
 \\[0.20cm]
2024 & 
{\href{https://drops.dagstuhl.de/entities/document/10.4230/LIPIcs.ITP.2024.13}{Completeness of Asynchronous Session Tree Subtyping in Coq}} \\
...
\begin{longtable}{lll}
2023-2024 & Invited Lecturer & Distributed Processes, Types and Programming
\\[0.15cm]	
2023-2024 & Invited Lecturer & Introduction to Proof Systems
\\[0.15cm]
...
\begin{longtable}{l}
Omer Keskin (MSc Thesis at CS Department)  University of Oxford  \\
Formalising a strong normalisation result for typed $\pi$-calculus in Coq. \\ 
supervisor: Nobuko Yoshida
\\[0.20cm]
Quanwen Chen (MSc Thesis at CS Department) University of Oxford  \\
Formalising Mac Lane's comparison theorem for the Eilenberg-Moore constructions in Coq.\\
supervisor: Nobuko Yoshida
\\[0.20cm]
Kimberley Tan (MSc Thesis at Math Department)  University of Oxford  \\
Formalisation of Synchronous Multiparty Session Types in Coq.\\
supervisor: Nobuko Yoshida
...
\begin{longtable}{lll}
Journals & Journal of Symbolic Computation & Reviewer
\\[0.20cm]
Conferences & ITP, FSCD, LICS, CICM, ATVA & Reviewer \\
& ATVA (24 and 25) & Member in Artifact Evaluation Committee
\end{longtable}
...
\subsection*{Others}
\begin{longtable}{ll}	
{\normalsize 10.09.2024} & {Completeness of Asynchronous Session Tree Subtyping in Coq.}\\
&
 \href{https://www.viam.science.tsu.ge/itp2024/program}{Fifteenth Conference on Interactive Theorem Proving.}\\[0.25cm]
...
\subsection*{Others}
\begin{longtable}{ll}	
{\small09-14.09.24} & Fifteenth Conference on Interactive Theorem Proving (ITP'24),\\
& Tbilisi-Georgia.\\[0.25cm]
